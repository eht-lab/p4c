...
#ifndef BACKENDS_APOLLO_COMMON_SHAREDACTIONSELECTORCHECK_H_
#define BACKENDS_APOLLO_COMMON_SHAREDACTIONSELECTORCHECK_H_
...
///  This is because Apollo considers that the selection key is part of the action_selector,
...
class SharedActionSelectorCheck : public Inspector {
 ...
 public:
    explicit SharedActionSelectorCheck(Apollo::ConversionContext *ctxt) : ctxt(ctxt) {
        refMap = ctxt->refMap;
    ...
    bool preorder(const IR::P4Table *table) override {
        ...
        for (auto ke : key->keyElements) {
            ...
            if (mt->name.name != Apollo::MatchImplementation::selectorMatchTypeName) continue;
...
#endif /* BACKENDS_APOLLO_COMMON_SHAREDACTIONSELECTORCHECK_H_ */
