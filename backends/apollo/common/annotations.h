...
#ifndef BACKENDS_APOLLO_COMMON_ANNOTATIONS_H_
#define BACKENDS_APOLLO_COMMON_ANNOTATIONS_H_
...
/// Parses Apollo-specific annotations.
class ParseAnnotations : public P4::ParseAnnotations {
 public:
    ParseAnnotations()
        : P4::ParseAnnotations("Apollo", false,
                               {
...
#endif /* BACKENDS_APOLLO_COMMON_ANNOTATIONS_H_ */
