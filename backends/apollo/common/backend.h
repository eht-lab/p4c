...
#ifndef BACKENDS_APOLLO_COMMON_BACKEND_H_
#define BACKENDS_APOLLO_COMMON_BACKEND_H_
...
class Backend {
 ...
 public:
    Backend(ApolloOptions &options, P4::ReferenceMap *refMap, P4::TypeMap *typeMap,
            P4::ConvertEnums::EnumMapping *enumMap)
        : options(options),
          refMap(refMap),
          typeMap(typeMap),
...
#endif /* BACKENDS_APOLLO_COMMON_BACKEND_H_ */
