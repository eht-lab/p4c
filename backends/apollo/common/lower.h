...
#ifndef BACKENDS_APOLLO_COMMON_LOWER_H_
#define BACKENDS_APOLLO_COMMON_LOWER_H_
...
/// This pass rewrites expressions which are not supported natively on Apollo.
...
#endif /* BACKENDS_APOLLO_COMMON_LOWER_H_ */
