...
#ifndef BACKENDS_APOLLO_COMMON_CONTROLFLOWGRAPH_H_
#define BACKENDS_APOLLO_COMMON_CONTROLFLOWGRAPH_H_
...
/// This CFG models the Apollo notion of control-flow graph.
/// In Apollo there are only 2 types of nodes: If and Table.
class CFG final : public IHasDbPrint {
 ...
 public:
    ...
    /// Apollo is very restricted in the kinds of graphs it supports.
 ...
 private:
    ...
    /// each other.  This is a constraint specific to Apollo.
    bool checkMergeable(std::set<TableNode *> nodes) const;
};

}  // namespace P4::Apollo

#endif /* BACKENDS_APOLLO_COMMON_CONTROLFLOWGRAPH_H_ */
