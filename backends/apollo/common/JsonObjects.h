...
#ifndef BACKENDS_APOLLO_COMMON_JSONOBJECTS_H_
#define BACKENDS_APOLLO_COMMON_JSONOBJECTS_H_
...
class JsonObjects {
 public:
    ...
    Util::JsonArray *verify_checksums;   // control verify_checksum generated checksums
    Util::JsonArray *compute_checksums;  // control compute_checksum generated checksums
...
#endif /* BACKENDS_APOLLO_COMMON_JSONOBJECTS_H_ */
