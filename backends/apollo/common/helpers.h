...
#ifndef BACKENDS_APOLLO_COMMON_HELPERS_H_
#define BACKENDS_APOLLO_COMMON_HELPERS_H_
...
class V1ModelProperties {
 public:
    ...
    /// The name of Apollo's valid field. This is a hidden bit<1> field
    /// automatically added by Apollo to all header types; reading from it tells
...
/// >= 20200408
enum class Arch { V1MODEL, PSA, PNA, V1MODEL2020, TUNA };
...
/// @ref CounterlikeTraits<> specialization for @ref MeterExtern for TUNA
template <>
struct CounterlikeTraits<Standard::MeterExtern<Standard::Arch::TUNA>> {
    static const cstring name() { return "meter"_cs; }
    static const cstring directPropertyName() { return "tuna_direct_meter"_cs; }
    static const cstring typeName() { return "TunaMeter"_cs; }
    static const cstring directTypeName() { return "TunaDirectMeter"_cs; }
    static const cstring sizeParamName() { return "size"_cs; }
    static std::optional<size_t> indexTypeParamIdx() { return std::nullopt; }
};

/// @ref CounterlikeTraits<> specialization for @ref CounterExtern for TUNA
template <>
struct CounterlikeTraits<Standard::CounterExtern<Standard::Arch::TUNA>> {
    static const cstring name() { return "counter"_cs; }
    static const cstring directPropertyName() { return "tuna_direct_counter"_cs; }
    static const cstring typeName() { return "TunaCounter"_cs; }
    static const cstring directTypeName() { return "TunaDirectCounter"_cs; }
    static const cstring sizeParamName() { return "size"_cs; }
    static std::optional<size_t> indexTypeParamIdx() { return std::nullopt; }
};
...
struct ConversionContext {
    ...
    /// Final json output.
    Apollo::JsonObjects *json;
    /// Generate bins or not
    bool generateBins;
...
#endif /* BACKENDS_APOLLO_COMMON_HELPERS_H_ */
