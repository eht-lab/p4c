...
#ifndef BACKENDS_APOLLO_COMMON_ACTION_H_
#define BACKENDS_APOLLO_COMMON_ACTION_H_
...
/// the primitives for one action in the Apollo JSON data.
...
#endif /* BACKENDS_APOLLO_COMMON_ACTION_H_ */
