...
#ifndef BACKENDS_APOLLO_COMMON_EXPRESSION_H_
#define BACKENDS_APOLLO_COMMON_EXPRESSION_H_
...
/// unbounded arithmetic, as in Apollo, it could produce a 33-bit value.
...
class ExpressionConverter : public Inspector {
    ...
    // in some cases the apollo JSON requires a 'bitwidth' attribute for hex
 ...
 public:
    ...
    ///                matches the specification.  Apollo does arithmetic using unbounded
...
#endif /* BACKENDS_APOLLO_COMMON_EXPRESSION_H_ */
