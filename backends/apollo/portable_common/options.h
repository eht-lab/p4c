...
#ifndef BACKENDS_APOLLO_PORTABLE_COMMON_OPTIONS_H_
#define BACKENDS_APOLLO_PORTABLE_COMMON_OPTIONS_H_
...
class PortableOptions : public ApolloOptions {
 public:
...
#endif /* BACKENDS_APOLLO_PORTABLE_COMMON_OPTIONS_H_ */
